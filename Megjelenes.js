...
export default class Megjelenes extends React.Component {
  ...
  ketezer = () => {
    return fetch('http://192.168.1.104:3000/ketezer')
  ...
  ezertiz = () => {
    return fetch('http://192.168.1.104:3000/ezertiz')
      .then((response) => response.json())
      .then((responseJson) => {
  ...
  ezerhusz = () => {
    return fetch('http://192.168.1.104:3000/ezerhusz')
      .then((response) => response.json())
      .then((responseJson) => {
  ...
  huszfelett = () => {
    return fetch('http://192.168.1.104:3000/huszfelett')
      .then((response) => response.json())
      .then((responseJson) => {
