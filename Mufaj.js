...
export default class Mufaj extends React.Component {
  ...
  Fantasy = () => {
    return fetch('http://192.168.1.105:3000/Fantasy')
  ...
  Drama = () => {
    return fetch('http://192.168.1.105:3000/Drama')
      .then((response) => response.json())
      .then((responseJson) => {
  ...
  Comedy = () => {
    return fetch('http://192.168.1.105:3000/Comedy')
      .then((response) => response.json())
      .then((responseJson) => {
  ...
  Action = () => {
    return fetch('http://192.168.1.105:3000/Action')
      .then((response) => response.json())
      .then((responseJson) => {
